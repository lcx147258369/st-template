<template>
  <view v-if="show" class="loading-container flex flex-vertical flex-align-center flex-justify-center">
      <image 
        class="loading-pic"
        :style="imgStyle" 
        :src="iconUri"
